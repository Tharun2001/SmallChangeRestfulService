...
--------------------------------------------------------
  ...
  INSERT INTO SC_TRADE(CLIENTID,trade_type,S_ID,QUANTITY,PRICE,TRADE_TIME)
  VALUES('ABC123','B',1,20,100, CURRENT_TIMESTAMP);
  
  INSERT INTO SC_HOLDING(CLIENTID, S_ID, QTY,INVESTED_AMOUNT)
  VALUES('ABC123',1,20,2000);
